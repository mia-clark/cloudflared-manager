      ...
      >
        ...
        >
          <Form.Item
            label="品牌名"
            name="app_name"
            extra="显示在侧边栏与登录页顶部。留空恢复默认「Cloudflared 隧道管理器」。"
          >
            <Input placeholder="Cloudflared 隧道管理器" maxLength={40} allowClear />
          </Form.Item>
          <Form.Item
            label="副标题"
            name="app_subtitle"
            extra="品牌名下方 / 登录页的小字说明。留空恢复默认「Cloudflare Tunnel 管理面板」。"
          >
            <Input placeholder="Cloudflare Tunnel 管理面板" maxLength={60} allowClear />
          </Form.Item>
          <Form.Item
            label="浏览器标签标题"
            name="html_title"
          ...
          >
            <Input placeholder="Cloudflared 隧道管理器 · Cloudflare Tunnel 管理面板" maxLength={120} allowClear />
          </Form.Item>
